...
export default function PollDisplay({ poll, onVote }) {
  ...
  return (
    <div className="bg-slate-950 p-6 rounded-lg shadow-lg text-white flex flex-col h-[400px] relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 flex">
        <button
            ...
            className="flex-1 bg-slate-950 hover:bg-slate-900 text-white py-3 cursor-pointer rounded-bl-lg disabled:opacity-50 disabled:cursor-not-allowed border-t-2 border-r border-white"
        >
        ...
        <button
            ...
            className="flex-1 bg-slate-950 hover:bg-slate-900 text-white py-3 cursor-pointer rounded-br-lg disabled:opacity-50 disabled:cursor-not-allowed border-t-2 border-l border-white"
        >
